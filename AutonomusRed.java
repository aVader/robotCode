...
public class AutonomusRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        backRight.setPower(1);
        while(true) {
            if (Color.red() > 10 && Color.blue() < 2 || Color.red() > 10 && Color.blue() < 2) ;
            {
                break;
            }
        }
        if (Color.red() > 4 && Color.blue() < 2); {
            frontLeft.setPower(1);
            frontRight.setPower(1);
            backLeft.setPower(-1);
            backRight.setPower(-1);
        ...
        backRight.setPower(1);
        while(true) {
            if (Color.red() > 4 && Color.blue() < 2 || Color.blue() > 4 && Color.red() < 2) ;
            {
                break;
            }
        }
